...
func NewSelector(page *crawler.Response, selector string) (form *Form) {
	form = New(page)
...
func (form *Form) Page(page *crawler.Response) {
	form.page = page
}
